...
not sure if linked lists are the best solution but idk what else to use atm
...
dynamically create ingredients(done)
    user input
...
Known bugs:
    Memory not yet freed, will fix later
    include error shows up in VScode but doesnt mean anything, ignore